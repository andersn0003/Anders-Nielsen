    ...
    return (
        <div className='flex flex-row justify-center gap-8'>
            <a href="https://mail.google.com/mail/u/0/#advanced-search/to=andersn0093%40gmail.com&query=in%3Asent&isrefinement=true&todisplay=andersn0093%40gmail.com?compose=new">
                <FontAwesomeIcon icon={faGoogle} size='lg' className='hover:text-red-500' />
            </a>
            <a href="https://discord.gg/andersn0095">
                <FontAwesomeIcon icon={faDiscord} size='lg' className='hover:text-purple-500' />
            </a>
            <a href="https://t.me/andersn0093">
                <FontAwesomeIcon icon={faTelegram} size='lg' className='hover:text-blue-500' />
            </a>
            ...
            <a href="https://github.com/coin5555">
                <FontAwesomeIcon icon={faGithub} size='lg' className='hover:text-green-500' />
            </a>
        </div>
    )
}
