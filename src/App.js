...
function App() {
  ...
  return (
    <div className="flex flex-row w-screen h-screen justify-center px-[15%] max-2xl:px-[10%] max-xl:px-[5%] max-[970px]:px-0 max-[860px]:flex-col ">
      ...
      <div className='hidden max-[860px]:flex flex-row items-center justify-between gap-[4%] sticky top-0 px-10 py-4 bg-gray-300 z-40'>
        <div className='flex flex-col items-center'>
          <img src='/img/avatar1.png' alt="" className='rounded-full shadow-md w-40 h-40 max-[470px]:w-32 max-[470px]:h-32' />
          <img src="https://readme-typing-svg.herokuapp.com?font=Serif&size=30&color=FFFFFFFF&pause=3000&size=32&center=true&vCenter=true&width=300&height=50&lines=Anders+Nielson;Kyiv+Ukraine;Co-Founder;Program+Engineer" alt="Headline" />
          <LinkBox />
        </div>
